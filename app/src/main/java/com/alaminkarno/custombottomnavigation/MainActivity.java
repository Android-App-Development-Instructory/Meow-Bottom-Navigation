package com.alaminkarno.custombottomnavigation;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final static int ACC_ID = 4;
    ...
    private void setItemOnBottomNavigation() {
        ...
        bottomNavigation.add(new MeowBottomNavigation.Model(ACC_ID,R.drawable.ic_baseline_account_circle_24));
